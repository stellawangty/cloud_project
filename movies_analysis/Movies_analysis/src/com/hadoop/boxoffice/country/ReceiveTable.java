...
//    public ReceiveTable(String name,String num){
//        this.name = name;
//        this.num = num;
//    }
    public ReceiveTable(String name,int num){
        this.name = name;
        this.num = num;
    }
    ...
    public void write(DataOutput out) throws IOException {
        ...
        2.其实这个效果和out.writeString(this.num)是一样的，只不过是DataOutput类型没有writeString()这个方法�?
